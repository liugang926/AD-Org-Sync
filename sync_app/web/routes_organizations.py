...
def register_organization_routes(
    ...
    *,
    ...
    canonical_page_path = CANONICAL_ROUTE_PATHS["organizations"]

    def _page_path(request: Request) -> str:
        return "/organizations" if request.url.path.startswith("/organizations") else canonical_page_path
    ...
    @app.post(CANONICAL_ROUTE_PATHS["organizations"])
    ...
    @app.post(f"{CANONICAL_ROUTE_PATHS['organizations']}/{{org_id}}/select")
    ...
    @app.get(f"{CANONICAL_ROUTE_PATHS['organizations']}/{{org_id}}/export")
    ...
    def organization_export(request: Request, org_id: str):
        ...
        if not organization:
            ...
            return RedirectResponse(url=_page_path(request), status_code=303)
        try:
    ...
    @app.post(f"{CANONICAL_ROUTE_PATHS['organizations']}/import")
    ...
    @app.post(f"{CANONICAL_ROUTE_PATHS['organizations']}/{{org_id}}/toggle")
    ...
    @app.post(f"{CANONICAL_ROUTE_PATHS['organizations']}/{{org_id}}/delete")
