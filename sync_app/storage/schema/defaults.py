...
DEFAULT_APP_SETTINGS = {
    ...
    "schedule_execution_mode": ("dry_run", "string"),
    ...
    "source_employee_id_attribute": ("", "string"),
    ...
    "brand_attribution": ("Enterprise Identity Operations", "string"),
